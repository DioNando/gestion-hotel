...
$routes->post('deleteChambre', 'Chambre::index', ['filter' => 'auth']);
...
$routes->post('updateClient', 'Client::index', ['filter' => 'auth']);
...
$routes->match(['get','post'], 'configTarif', 'Chambre::configTarif', ['filter' => 'isadmin']);
