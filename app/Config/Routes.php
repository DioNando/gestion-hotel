...
$routes->match(['get','post'], 'addChambre', 'Chambre::addChambre', ['filter' => 'isadmincontro']);
$routes->post('updateStatut', 'Chambre::updateStatut', ['filter' => 'auth']);
$routes->post('updateChambre', 'Chambre::index', ['filter' => 'auth']);
$routes->post('addBed', 'Chambre::addBed', ['filter' => 'auth']);
$routes->post('updateChambreReservation', 'Chambre::updateChambreReservation', ['filter' => 'auth']);
$routes->post('deleteChambre', 'Chambre::index', ['filter' => 'isadmincontro']);
$routes->post('saveTarif', 'Chambre::saveTarif', ['filter' => 'isadmincontro']);
$routes->post('facture', 'Facture::index', ['filter' => 'auth']);
$routes->match(['get','post'], 'addClient', 'Client::addClient', ['filter' => 'auth']);
$routes->post('updateClient', 'Client::index', ['filter' => 'isadmincontro']);
$routes->post('liveSearch', 'Client::liveSearch', ['filter' => 'auth']);
...
$routes->match(['get','post'], 'configTarif', 'Chambre::configTarif', ['filter' => 'isadmincontro']);
