        ...
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 mt-2 mb-2 text-center">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="somme_donne_nuit" value="0" onclick="calculFacture(this.value, <?php echo ($total - $remise) ?>)" onmousedown="calculFacture(this.value, <?php echo ($total - $remise) ?>)" onkeyup="calculFacture(this.value, <?php echo ($total - $remise) ?>)" min="0">
                                </div>
                            </div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo number_format(($total - $remise) - $facture['somme_donne_nuit'], '0', '', ' ') . ' Ar' ?></td>
                </tr>
