                    ...
                    <tr>
                        ...
                        <?php if (session()->get('isUser') == 'Administrateur') : ?>
                            <td>
                                <div class="center">
                                    <div>
                                        <button type="button" class="btn btn-outline-warning btn-icon btn-sm" data-bs-toggle="modal" data-bs-target="#modalUserUpdate" onclick="updateData('<?php echo $user['ID_user']; ?>' , '<?php echo $user['nom_user']; ?>' , '<?php echo $user['prenom_user']; ?>' , '<?php echo $user['droit_user']; ?>')"><img src="assets/icons/pencil-fill.svg" alt="Modifier"></button>
